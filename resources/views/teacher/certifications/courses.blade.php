@include('partials.header', ['title' => 'Certifications'])
<div class="main-container">
    @include('partials.sidebar', ['active' => 'certifications'])
    <main class="main home w-full">
        @include('partials.navbar', ['page_title' => 'Certifications'])
                ...
                <div class="course-container">
                    <div class="course-section">
                        <div class="course-display name-color-{{strtolower($course->name[0])}}">
                            ...
                            {{-- <div class="course-desc"><span>{{ $course->description }}</span></div> --}}
                            <div class="course-desc"><span>Invite Code:&nbsp;{{ $course->invite_code }}</span></div>
                        </div>
                        <div class="course-menu">
                            <ul class="course-menu-items">
                                ...
                                <li>
                                    <a href="{{ route('teacher.certify.students', ['course'=> $course->id]) }}"  class="course-menu-button menu-options">
                                        <i class='bx bx-certification menu-button-icon' ></i>
                                        <span class="hidden lg:block">&nbsp;Give Certificates</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
