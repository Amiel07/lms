...
@php
    $filepath = public_path('files/'.$material->resource);
@endphp
        ...
        <section class="courses-main-section">
            ...
            <div class="section-content bg-white w-full h-[550px] rounded-md pt-8 pb-4 px-5">
                ...
                <div class="form-container">
                    <form action="{{ route('teacher.materials.update') }}" enctype="multipart/form-data" method="POST" class="grid grid-cols-2 gap-8 w-full">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="name" id="" class="border-solid border-2 custom-input" value="{{$material->name}}">
                        </div>
                        <div class="flex flex-col ">
                            ...
                            <select name="type" id="resourceType" class="border-solid border-2 custom-input" onchange="typeChange(this)">
                                <option value="1" @if ($material->type === 1) selected @endif>File</option>
                                <option value="2" @if ($material->type === 2) selected @endif>Link</option>
                        ...
                        <div class="flex flex-col col-span-2">
                            ...
                            <input type="{{ $material->type === 1 ? 'file' : 'text' }}" id="inputFile" name="resource" class="border-solid border-2 custom-input" 
                                @if ($material->type === 2)
