        ...
        <section class="courses-main-section">
            ...
            <div class="section-content bg-white w-full h-[550px] rounded-md pt-8 pb-4 px-5">
                ...
                <div class="form-container">
                    <form action="{{ route('teacher.courses.save_new',['']) }}" method="POST" class="grid grid-cols-2 gap-8 w-full">
                        @csrf
                        <div class="flex flex-col">
                            <label for="" class="custom-label">Course Code</label>
                            <input type="text" name="course_code" id="" class="border-solid border-2 custom-input">
                        </div>
                        <div class="flex flex-col">
                        ...
                        <div class="flex flex-col col-span-2">
                            ...
                            <textarea type="text" name="description" id="" class="border-solid border-2 custom-input"></textarea>
                        </div>

                        <div class="flex flex-col">
                            <label for="" class="custom-label">Meeting Link</label>
                            <input type="text" name="meeting_link" id="" class="border-solid border-2 custom-input">
                        </div>
                        ...
                        <div class="flex flex-col">
                            ...
                            <input type="text" name="invite_code" id="invite_code" class="border-solid border-2 custom-input w-full" >
                        ...
                        <div class="flex flex-col">
                            ...
                            <div class="flex flex-nowrap flex-row gap-2">
                                <input type="checkbox" name="power_ups" value="checked" class="text-sm">Allow Power Ups</input>
                            </div>
                            {{-- <div class="flex flex-nowrap flex-row gap-2">
