@include('partials.header', ['title' => $course->course_code . ' - ' . 'Submissions'])
        ...
        <section class="courses-main-section">
            ...
            <div class="section-header bg-white w-full h-[auto] rounded-md p-4 shadow-lg flex flex-col gap-2">
                <div class="bg-white breadcrumbs-student w-full h-aut py-2 px-4 rounded-md">
                    ...
                    <a href="" class="">> {{$module->name}} Submissions</a>
                </div>
            ...
            <div class="section-content flex flex-col gap-16 bg-white w-full h-[550px] rounded-md pt-8 pb-4 px-5 shadow-lg">
                <div class="w-full h-auto">
                    <span class="text-xl">
                        Submission List for {{$module->name}}
                    </span>
                </div>
                <hr>
                    ...
                    <table class="w-full border-collapse">
                        <thead>
                            <tr>
                                ...
                                <th class="px-2 py-1 text-start">Submitted Files</th>
                        ...
                        <tbody>
                            ...
                            @php
                                ...
                                $submittedFiles = getSubmittedFiles($enrollee->id, $course->id, $module->id);
                            @endphp
                            ...
                            <tr class="hover:bg-blue-100">
                                ...
                                <td class="px-2 py-1 uppercase text-xs">{{ count($submittedFiles) }}</td>
                                <td class="px-2 py-1 uppercase text-xs text-start">
                                    <form action="{{route('module.submitted')}}" target="_blank" method="POST" class="">
                                        @csrf
                                        <input type="hidden" name="student_id" value="{{$enrollee->id}}"></input>
