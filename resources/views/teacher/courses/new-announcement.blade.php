...
<div class="main-container">
    ...
    <main class="main home w-full">
        @include('partials.navbar', ['page_title' => 'Courses > ' . $course->course_code . ' > ' . 'Announcements' ])
        ...
        <section class="courses-main-section">
            ...
            <div class="section-menu bg-white w-full h-auto rounded-md p-4 shadow-lg">
                <ul class="">
                    <li>
                        <a href="{{ route('student.open_course', ['course'=> $course->id]) }}" class="py-2 px-6 bg-[var(--custom-darkblue)] text-white rounded-md">
                            Start Learning
                        </a>
                    </li>
                </ul>
