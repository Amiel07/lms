        ...
        <section class="courses-main-section">
            ...
            <div class="section-header bg-white w-full h-[66px] rounded-md p-4 shadow-lg">
                <div class="bg-white breadcrumbs-student w-full h-aut py-2 px-4 rounded-md">
                    ...
                    <a href="" class="">> Archived Courses </a>
                </div>
            </div>
                    ...
                    <div class="course-section">
                        ...
                        <div class="course-menu">
                            <ul class="course-menu-items">
                                ...
                                <li>
                                    <form class="unarchiveCourseForm m-0" action="{{ route('teacher.courses.archive', ['course' => $course->id]) }}" method="POST">
                                        @csrf
                                        <button type="submit" class="course-menu-button menu-options">
                                            <i class='bx bx-archive-out menu-button-icon'></i>
                                            <span class="hidden lg:block">&nbsp;Unarchive</span>
                                        </button>
                                    </form>
                                </li>
                                {{-- <li>
                ...
                {{-- <div class="module-template">
                    ...
                    <div>
                        <ul class="module-menu">
                            ...
                            <li>
                                <a href="{{ route('teacher.modules.all', ['course'=> $course->id]) }}">
                                    <button>
