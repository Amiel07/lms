    ...
    <main class="main home w-full">
        ...
        <section class="courses-main-section">
            ...
            <div class="section-content bg-white w-full h-[550px] rounded-md pt-8 pb-4 px-5">
                ...
                <form action="{{ route('assessments.store', ['course' => $course->id]) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="flex flex-col gap-2">
                        <label for="" class="custom-label">Name</label>
                        <input type="text" name="assessment_name" id="" class="border-solid border-2 custom-input" required>
                        <label for="" class="custom-label">Directions</label>
                        <textarea type="text" name="direction" id="" class="border-solid border-2 custom-input" required></textarea>
                        <div class="flex flex-row flex-nowrap gap-2">
                            <input type="checkbox" id="checkBox" name="powerups" value="true">
                            <label for="checkBox" class="custom-label uppercase font-bold">ENABLE POWERUPS</label>
                        </div>
                    </div>

                    <div id="items-container" class="my-2"></div>
