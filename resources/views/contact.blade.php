@include('partials.header', ['title' => 'Contact'])
...
<nav class="bg-transparent">
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <a href="/" class="flex flex-shrink-0 items-center w-full">
            ...
            <div class="flex flex-col gap-8 text-center md:px-20">
                ...
                <div class="w-full">
                    <p class="text-lg font-normal leading-tight">
                        For further inquiries or assistance, please contact us at the following emails:
                    </p>
                </div>
                <div class="mt-8 w-full flex flex-col text-lg">
                    <span>juanmiguel.coleto@g.batstate-u.edu.ph</span>
                    <span>william.cruzjr@g.batstate-u.edu.ph</span>
                    <span>marcelo.socorro@g.batstate-u.edu.ph</span>
                    <span>22-01949@g.batstate-u.edu.ph</span>
                    <span>geneamhiel.velasquez@g.batstate-u.edu.ph</span>
                </div>
